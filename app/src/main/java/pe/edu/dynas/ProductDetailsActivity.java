    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        addToCartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                {
                    Toast.makeText(ProductDetailsActivity.this, "Podrás agregar productos una vez tu orden haya sido confirmada o enviada.", Toast.LENGTH_LONG).show();
                }
                else
                {
                    addingToCartList();
        ...
        productsRef.child(productID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                    ...
                    realPrice = parseFloat(products.getPrice());
                    productPrice.setText("S/. " + realPrice);
